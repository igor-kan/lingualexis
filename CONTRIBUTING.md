# Contributing to lingualexis

Thank you for your interest in contributing to lingualexis! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/lingualexis.git
   cd lingualexis
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/lingualexis.git
   ```
...
By contributing to lingualexis, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
